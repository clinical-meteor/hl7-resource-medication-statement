...
BaseSchema.extend(MedicationStatementSchema);
DomainResourceSchema.extend(MedicationStatementSchema);
MedicationStatements.attachSchema(MedicationStatementSchema);

export default { MedicationStatement, MedicationStatements, MedicationStatementSchema };